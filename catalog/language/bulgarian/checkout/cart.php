<?php
// Heading  
$_['heading_title']          = 'Моята количка';

// Text
$_['text_success']           = '<a href="%s">%s</a>е успешно добавен в <a href="%s">количката.</a>!';
...
$_['text_shipping_estimate'] = 'Изчисляване доставка &amp; ДДС';
$_['text_shipping_detail']   = 'Enter your destination to get a shipping estimate.';
$_['text_shipping_method']   = 'Please select the preferred shipping method to use on this order.';
$_['text_empty']             = 'Не си добавил продукти в количката!!';
...
$_['column_name']            = 'Поръчан продукт';
$_['column_model']           = 'Код';
$_['column_quantity']        = 'Количество';
$_['column_price']           = 'Ед.цена';
$_['column_total']           = 'Крайна цена';

// Entry
$_['entry_coupon']           = 'Въведете код от ваучер за отстъпка:';
$_['entry_voucher']          = 'Въведете код от ваучер за отстъпка.:';
$_['entry_reward']           = 'Points to use (Max %s):';
$_['entry_country']          = 'Държава:';
$_['entry_zone']             = 'Населено място:';
...
$_['error_zone']             = 'Изберете населено място!';
